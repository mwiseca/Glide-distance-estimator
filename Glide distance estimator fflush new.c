...
int main(){
       	...
       	char ac [8]  [20] = {"aircraft a","aircraft b","aircraft c","aircraft d","aircraft e","aircraft f","aircraft g","aircraft h"}; 
...
printf("Enter a aircraft, x to exit or i for index.\n");
	...
	break;}
 else if(strcmp(aircraft,ac[0])==0){
 glide_ratio = gr[0];
 ...
 glide_ratio = gr[7];}
	...
	fflush(stdin);
        ...
        continue;}
        fflush(stdin);	
	printf("\nThe glide distance is %f",alt * glide_ratio  / 5280);
	printf(" miles.\n\n");
     }
return 0;
}
